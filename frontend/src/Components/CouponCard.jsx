...
const CouponCard = ({ coupon, onApply, isActive }) => {
  return (
    <div
    ...
    >
      <div className="font-semibold text-sm mb-2">{coupon.description}</div>
      <div className="bg-gray-100 inline-block px-2 py-1 rounded-md text-xs mb-2">{coupon.couponCode}</div>
